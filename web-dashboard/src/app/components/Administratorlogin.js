...
export default function AdministratorLogin({ portal, onBack, router }) {
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 relative">
        ...
        <div className="w-full max-w-md">
          <div className="md:hidden flex items-center space-x-2 mb-8 justify-center">
            ...
            <span className="text-xl font-bold">Safai<span className="text-blue-500">Mitra</span></span>
          </div>

          <div className="text-center md:text-left mb-10">
            <h3 className="text-3xl font-bold text-gray-900 mb-2">Administrator Login</h3>
            <p className="text-gray-500">Enter your admin credentials to access the system.</p>
          </div>

          <form onSubmit={handleLoginSubmit} className="space-y-6">
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">Admin ID / Username</label>
              <input
                type="text"
                placeholder="Enter your admin ID"
                className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all text-black"
                required
                value={username}
