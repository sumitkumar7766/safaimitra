...
export default function VehicleStaffLogin({ portal, onBack, router }) {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:5001/staff/login", {
        username,
        password,
      });
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 relative">
        ...
        <div className="w-full max-w-md">
          <div className="md:hidden flex items-center space-x-2 mb-8 justify-center">
            ...
            <span className="text-xl font-bold">Safai<span className="text-orange-500">Mitra</span></span>
          </div>

          <div className="text-center md:text-left mb-10">
            <h3 className="text-3xl font-bold text-gray-900 mb-2">Vehicle Staff Login</h3>
            <p className="text-gray-500">Enter your credentials to access the staff portal.</p>
          </div>
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition-all text-black"
                required
                value={username}
